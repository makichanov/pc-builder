package com.makichanov.pcbuilder;

import com.makichanov.pcbuilder.controller.AddPartController;
import com.makichanov.pcbuilder.controller.PartsManagerController;
...
public class Main extends Application {
    ...
    public static void showManager() {
        try {
            ...
            loader.setLocation(Main.class.getResource("/fxml/partsManagerDialog.fxml"));
    ...
    public static void addPartWindow() {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/fxml/addPartDialog.fxml"));
            AnchorPane page = loader.load();
